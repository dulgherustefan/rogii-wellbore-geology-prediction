...
def likpf_rows_for_well(wid, split):
    ...
    if len(ev_idx) == 0:
        return None
    pf_by_scale = run_pf_lik_ensemble_scales(hw, tw, scales=SELECTOR_SCALES, n_particles=350, n_seeds=192)
    # 96 -> 192: measured on 120 train wells the lik-PF leg drops 12.560 -> 12.448.
    # Diminishing (48 -> 96 was 13.051 -> 12.560), so this is worth ~0.02 CV, but the
    # leg carries 0.40 of the post-process directly and the change is pure variance.
