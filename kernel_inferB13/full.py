...
class PP_B:
    ...
    # 0.85 = the far end of the bracket. Half A of the weight sweep kept improving
    # all the way to 0.85 (8.1084) while half B degraded past 0.65; iter11 then beat
    # its CV delta by 2.4x on the leaderboard, which says the train-well CV
    # understates the model. Submitted alongside w=0.75 rather than after it,
    # because the scoring queue is ~12 h and serialising the search costs a day.
    w_sub1 = 0.85
    sub2_scale = "scale_5"
    sg_win = 61
    sg_poly = 3
